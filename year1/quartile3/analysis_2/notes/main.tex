...
\begin{document}
    ...
    \include{chapters/standard_functions}
    ...
    \include{chapters/polynomial_approximations}
    ...
    \include{chapters/riemann_integration_1d}

    \include{chapters/riemann_integration_nd}
