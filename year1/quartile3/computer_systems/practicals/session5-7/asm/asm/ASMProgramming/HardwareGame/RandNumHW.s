...
.equ        SYS_EXIT,   0x1
.equ        TIMER_ADDR, 0x3F003000 @ TASK: Add clock hardware address constant
...
main:     
    ...
    LDR     R0, #TIMER_ADDR                            @ TASK: Load hardware clock address
    BL      map                 @ Map hardware clock to memory (R0 contains address)
    LDR     R0, =clockbase                            @ TASK: Load address of clockbase variable
