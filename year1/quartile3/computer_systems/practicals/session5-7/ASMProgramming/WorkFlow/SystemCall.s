...
main:                               @ 0 - This is the start of the program
    LDR R1, =t1                     @ Load the address of the string to print
    MOV R2, #t1_len                 @ Load the length of the string
    BL print                        @ Make the system call (jump to print function)
    ...
    LDR R1, =t2                     @ 4 - Load the address of the string to print
    MOV R2, #t2_len                 @ 5 - Load the length of the string
    BL print                        @ 6 - Make the system call (jump to print function)
...
.data       
t1:                .ascii "Hi, my name is "
            .equ    t1_len, 15
name:             .ascii "Dorothy"
            .equ    name_length, 7
t2:                .ascii " and I am from "
            .equ    t2_len, 15
place:            .ascii "Kansas\n"
            .equ   place_length, 7
